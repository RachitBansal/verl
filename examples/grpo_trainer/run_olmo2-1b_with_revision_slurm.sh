...
OLMO_CHECKPOINT="allenai/OLMo-2-0425-1B"
OLMO_REVISION="main"
...
python3 -m verl.trainer.main_ppo \
    ...
    'data.apply_chat_template_kwargs.chat_template={% for message in messages %}{{ message["content"] }}{% endfor %}{% if add_generation_prompt %}{{ "\n" }}{% endif %}' \
    actor_rollout_ref.model.path=$OLMO_CHECKPOINT \
    actor_rollout_ref.model.revision=$OLMO_REVISION \
    ...
    trainer.experiment_name="olmo2_1b_${OLMO_REVISION}" \
