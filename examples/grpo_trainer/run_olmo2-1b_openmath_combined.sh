#!/usr/bin/env bash
# Combined SFT+RL training on OLMo2-1B with OpenMathInstruct2/GSM8K
# Both RL and SFT losses are applied every step (weighted sum).
