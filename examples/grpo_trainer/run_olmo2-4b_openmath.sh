#!/usr/bin/env bash
# GRPO training with OLMo2-4B on OpenMathInstruct-2 GSM8K subset
# Author: Sunny + Claude
...
STEP_NUM=${STEP_NUM:-5000}
OLMO_CHECKPOINT=${OLMO_CHECKPOINT:-"/n/netscratch/dam_lab/Everyone/rl_pretrain/OLMo2-4B-stage1-50B/step${STEP_NUM}-hf"}
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name="olmo2_4b_step${STEP_NUM}_omi_n32" \
    trainer.default_local_dir="${OUTPUT_DIR}/olmo2_4b_step${STEP_NUM}_omi_n32" \
