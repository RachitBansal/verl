...
# Usage:
#   sbatch --job-name=math-1k \
#       --export=ALL,STEP_NUM=1000,SFT_DATA_DIR=...,NUM_SFT_STEPS=5000,NUM_PPO_STEPS=0,EXP_SUFFIX=... \
#       examples/grpo_trainer/run_olmo2-1b_openmath_math_interleave_slurm.sh
...
# Run the interleaved SFT+RL training script (MATH version)
bash examples/grpo_trainer/run_olmo2-1b_openmath_math_interleave.sh "$@"
