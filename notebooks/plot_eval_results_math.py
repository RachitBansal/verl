...
# Direct RL:   olmo2_4b_step{pt}_omi_n{r}-step{rl}-rl-0shot-boxed-{samples}samples-temp{temp}
...
pre4b_rows, rl4b_rows, sft4b_single_rows = [], [], []
...
print(f"4B loaded: {len(pre4b_df)} pretrain, {len(rl4b_df)} RL, {len(sft4b_single_df)} SFT-Single")
