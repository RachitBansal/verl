#!/bin/bash
#
# Evaluation script for OLMo-2 RL model on GSM-8K dataset
...
# Model Configuration
MODEL_PATH=/n/netscratch/dam_lab/Everyone/rl_pretrain/experiments/OLMo2-1B-step14000-stage2-openmathgsm8k-5epoch/step1389-hf
MODEL_NAME=OLMo2-1B-step14000-stage2-openmathgsm8k-5epoch-step1389-hf
N_SAMPLES=1
...
echo "[Step 0/4] Verifying model checkpoint..."
...
if [ "${N_SHOT}" -gt 0 ]; then
    echo "[Step 2/4] Applying ${N_SHOT}-shot examples..."
    ...
    echo "✓ Few-shot dataset created"
else
    echo "[Step 2/4] Skipping few-shot (0-shot evaluation with boxed prompt)..."
...
echo "[Step 3/4] Generating responses on GSM-8K..."
